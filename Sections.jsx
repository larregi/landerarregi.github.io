      ...
      <div className="lp-wrap">
        ...
        <div className="lp-footer__row">
          <div className="lp-footer__col">
            <h5>About</h5>
            <p>Senior product designer based in Tallinn, working remotely with teams worldwide.</p>
          </div>
          <div className="lp-footer__col">
            <h5>Elsewhere</h5>
            <a href="#linkedin">LinkedIn ↗</a>
            <a href="#dribbble">Dribbble ↗</a>
            <a href="#read">Read.cv ↗</a>
          </div>
          <div className="lp-footer__col">
            <h5>Sections</h5>
          ...
          <div className="lp-footer__col">
            <h5>Contact</h5>
            <a href="mailto:hello@larregi.com">hello@larregi.com</a>
            <p>Tallinn, EE</p>
          </div>
        </div>
        <div className="lp-footer__base">
          <span>© 2026 Lander Arregi · Redesigned with care</span>
